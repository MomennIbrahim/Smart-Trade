...
import '../../data/repository/activate_bots_repository_implementation.dart';
import '../controller/activate_bots_cubit.dart';
...
class MyActivateBotsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => ActivateBotsCubit(getIt.get<ActivateBotsRepositoryImplementation>())
        ..getActivateBots(),
      child: Scaffold(
